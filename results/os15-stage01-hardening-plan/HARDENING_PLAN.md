...
OS v1.5 hardens the OS v1 candidate by adding receipt-backed scale execution, package manifests, search indexes, class hardening, replay sampling, and route policy v4 audits.
