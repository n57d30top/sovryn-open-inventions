...
public accept re-review receipt now exists. A second public comment records a
fresh-checkout reproduction context with environment and output hash. Both
GitHub receipts are owner-authored and therefore not independent or
score-effective.
...
| `REVIEW-INTAKE-007` | public fresh-checkout reproduction context | https://github.com/n57d30top/sovryn-open-inventions/issues/1#issuecomment-4470417022 | public fresh-checkout V2 100-claim reproducer passed | reproduction_context_only | yes, reproducibility | no          | no              | Public receipt includes OS, Node, commit, command, output file, and SHA-256, but is owner-authored and explicitly not independent external validation. |
...
- candidate status is `pipeline_fund_candidate_public_fresh_checkout_reproduction_independence_missing`,
