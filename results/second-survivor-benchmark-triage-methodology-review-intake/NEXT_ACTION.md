...
- confirm V2 yield `1.000`,
- confirm baseline-only yield `0.680`,
- confirm 8 baseline-only false advances,
- assess whether the V2 method is methodologically useful beyond package
  arithmetic,
