...
- [External Reproduction and Extension Result](results/external-reproduction-extension-result/) — unknown, autopublished, external-reproduction-extension-result, scientific-claim-evidence-extraction
