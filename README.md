...
- [Unit normalization plus provenance scoring improves inconsistent record detection compared with unit normalization alone.](results/chemistry-data-quality-self-built-lab-study/) — good, autopublished, chemistry-data-quality-self-built-lab-study, chemistry-data-quality
...
- [Provenance-aware anomaly scoring reduces false positives compared with simple threshold baselines.](results/energy-data-quality-self-built-lab-study/) — good, autopublished, energy-data-quality-self-built-lab-study, energy-data-quality
...
- [Dependency provenance plus test-impact signals improves detection of risky synthetic AI-generated patches compared with diff-pattern-only baselines.](results/software-supply-chain-assurance-self-built-lab-study/) — good, autopublished, software-supply-chain-assurance-self-built-lab-study, software-supply-chain-assurance
