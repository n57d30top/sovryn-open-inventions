...
- [Public Formal Replay Package: Graph-Minor Obstruction Boundary Candidate](results/first-formal-discovery-fund-graph-minor-obstruction-boundary/) — reviewable, autopublished, first-formal-discovery-fund-graph-minor-obstruction-boundary, formal_mathematics_conjecture_refutation
